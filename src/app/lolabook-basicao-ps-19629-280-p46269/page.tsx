...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/lolabook-basicao-ps-19629-280-p46269-fe56d4b6/PageContent";

export const metadata: Metadata = {"title":"LOLABOOK BASICAO -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46269 ts-theme-light" />
      <section id="main" className="context-product-46269">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
