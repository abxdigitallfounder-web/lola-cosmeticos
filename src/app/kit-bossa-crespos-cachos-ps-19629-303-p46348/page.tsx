...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-bossa-crespos-cachos-ps-19629-303-p46348-24adca76/PageContent";

export const metadata: Metadata = {"title":"Kit Bossa Crespos & Cachos -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46348 ts-theme-light" />
      <section id="main" className="context-product-46348">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
