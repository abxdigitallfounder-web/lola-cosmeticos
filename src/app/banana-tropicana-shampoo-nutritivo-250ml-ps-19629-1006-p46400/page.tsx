...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/banana-tropicana-shampoo-nutritivo-250ml-ps-19629-1006-p46400-49389350/PageContent";

export const metadata: Metadata = {"title":"BANANA TROPICANA SHAMPOO NUTRITIVO 250ML -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46400 ts-theme-light" />
      <section id="main" className="context-product-46400">
