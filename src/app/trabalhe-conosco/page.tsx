...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/trabalhe-conosco-af4132c0/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 trabalhe-conosco" />
      <section id="main" className="trabalhe-conosco">
