...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-purple-linha-completa-p46314-7638e4a6/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46314 ts-theme-light" />
      <section id="main" className="context-product-46314">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
