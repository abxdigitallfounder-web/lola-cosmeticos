...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/a-formula-100g-ps-19629-291-p46291-adcb92cf/PageContent";

export const metadata: Metadata = {"title":"A FORMULA 100G -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46291 ts-theme-light" />
      <section id="main" className="context-product-46291">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
