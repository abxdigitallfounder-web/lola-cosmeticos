...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/plot-twist-shampoo-sem-enxague-200ml-ps-19629-255-p46170-10f6bff7/PageContent";

export const metadata: Metadata = {"title":"Plot Twist Shampoo Sem Enxágue 200ml -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46170 ts-theme-light" />
      <section id="main" className="context-product-46170">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
