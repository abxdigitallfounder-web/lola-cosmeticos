...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/plot-twist-guava-mousse-150-ml-ps-19629-149-p45527-8eb8352e/PageContent";

export const metadata: Metadata = {"title":"PLOT TWIST GUAVA MOUSSE 150 ML -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-45527 ts-theme-light" />
      <section id="main" className="context-product-45527">
