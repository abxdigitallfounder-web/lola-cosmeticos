...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/plot-twist-guava-cream-480g-ps-19629-147-p45666-ec19ab2b/PageContent";

export const metadata: Metadata = {"title":"PLOT TWIST GUAVA CREAM 480G -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-45666 ts-theme-light" />
      <section id="main" className="context-product-45666">
