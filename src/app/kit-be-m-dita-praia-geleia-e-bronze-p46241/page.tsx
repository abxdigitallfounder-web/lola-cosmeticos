...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-be-m-dita-praia-geleia-e-bronze-p46241-38a490ce/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46241 ts-theme-light" />
      <section id="main" className="context-product-46241">
