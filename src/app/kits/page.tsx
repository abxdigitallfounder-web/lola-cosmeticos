...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kits-05782adf/PageContent";

export const metadata: Metadata = {"title":"KITS | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1464 grid-products" />
      <section id="main" className="context-category-1464 grid-products">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
