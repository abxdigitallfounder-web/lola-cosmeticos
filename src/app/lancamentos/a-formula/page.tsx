...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/lancamentos-a-formula-dc3e0f11/PageContent";

export const metadata: Metadata = {"title":"A Fórmula | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1707 grid-products" />
      <section id="main" className="context-category-1707 grid-products">
