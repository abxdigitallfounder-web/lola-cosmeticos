...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/lancamentos-banana-tropicana-5d791379/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1827 grid-products" />
      <section id="main" className="context-category-1827 grid-products">
