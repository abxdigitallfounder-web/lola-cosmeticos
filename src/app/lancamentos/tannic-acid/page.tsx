...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/lancamentos-tannic-acid-ae66004a/PageContent";

export const metadata: Metadata = {"title":"Tannic Acid | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1711 grid-products" />
      <section id="main" className="context-category-1711 grid-products">
