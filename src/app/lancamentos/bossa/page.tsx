...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/lancamentos-bossa-81b465be/PageContent";

export const metadata: Metadata = {"title":"Bossa | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1696 grid-products" />
      <section id="main" className="context-category-1696 grid-products">
