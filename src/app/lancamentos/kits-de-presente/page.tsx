...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/lancamentos-kits-de-presente-570541da/PageContent";

export const metadata: Metadata = {"title":"Kits de presente | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1681 grid-products" />
      <section id="main" className="context-category-1681 grid-products">
