...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/lancamentos-volumao-03b55985/PageContent";

export const metadata: Metadata = {"title":"Volumão | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1811 grid-products" />
      <section id="main" className="context-category-1811 grid-products">
