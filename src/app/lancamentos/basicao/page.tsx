...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/lancamentos-basicao-91056a68/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1680 grid-products" />
      <section id="main" className="context-category-1680 grid-products">
