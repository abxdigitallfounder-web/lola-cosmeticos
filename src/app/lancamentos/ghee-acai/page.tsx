...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/lancamentos-ghee-acai-6c03e1fc/PageContent";

export const metadata: Metadata = {"title":"Ghee Açaí | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1743 grid-products" />
      <section id="main" className="context-category-1743 grid-products">
