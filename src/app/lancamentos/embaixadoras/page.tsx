...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/lancamentos-embaixadoras-e73def54/PageContent";

export const metadata: Metadata = {"title":"Embaixadoras | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1785 grid-products" />
      <section id="main" className="context-category-1785 grid-products">
