...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/lancamentos-11622ffd/PageContent";

export const metadata: Metadata = {"title":"LANÇAMENTOS | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1460 grid-products" />
      <section id="main" className="context-category-1460 grid-products">
