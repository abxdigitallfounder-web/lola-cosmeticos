...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/onde-encontrar-c3073c3f/PageContent";

export const metadata: Metadata = {"title":"Onde encontrar -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 PointOfSaleRoute area-shopping page-point-of-sale-index" />
      <section id="main" className="PointOfSaleRoute">
