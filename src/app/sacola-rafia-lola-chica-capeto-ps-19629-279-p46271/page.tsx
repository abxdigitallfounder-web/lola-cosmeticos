...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/sacola-rafia-lola-chica-capeto-ps-19629-279-p46271-cc9c0d92/PageContent";

export const metadata: Metadata = {"title":"SACOLA RAFIA LOLA + CHICA CAPETO -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46271 ts-theme-light" />
      <section id="main" className="context-product-46271">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
