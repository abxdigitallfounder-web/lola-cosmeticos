...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-meu-cacho-minha-vida-b69609e9/PageContent";

export const metadata: Metadata = {"title":"Meu Cacho minha Vida | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1485 grid-products" />
      <section id="main" className="context-category-1485 grid-products">
