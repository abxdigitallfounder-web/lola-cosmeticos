...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-be-m-dita-ghee-dac46a89/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 kit-cronolola-lp" />
      <section id="main" className="kit-cronolola-lp">
