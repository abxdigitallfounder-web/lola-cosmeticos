...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-tarja-preta-d2cf1eb8/PageContent";

export const metadata: Metadata = {"title":"Tarja Preta | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1492 grid-products grid-empty" />
      <section id="main" className="context-category-1492 grid-empty">
