...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-cuca-fresca-4a416ea6/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1726 grid-products" />
      <section id="main" className="context-category-1726 grid-products">
