...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-tannic-acid-8308867a/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1710 grid-products" />
      <section id="main" className="context-category-1710 grid-products">
