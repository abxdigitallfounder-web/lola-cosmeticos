...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-lola-vintage-girls-161e70ce/PageContent";

export const metadata: Metadata = {"title":"Lola Vintage Girls | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1484 grid-products grid-empty" />
      <section id="main" className="context-category-1484 grid-empty">
