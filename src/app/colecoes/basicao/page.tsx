...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-basicao-85218c83/PageContent";

export const metadata: Metadata = {"title":"Basicão | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1679 grid-products" />
      <section id="main" className="context-category-1679 grid-products">
