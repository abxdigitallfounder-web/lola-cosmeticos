...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-ela-e-carioca-85dc5383/PageContent";

export const metadata: Metadata = {"title":"Ela é Carioca | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1478 grid-products" />
      <section id="main" className="context-category-1478 grid-products">
