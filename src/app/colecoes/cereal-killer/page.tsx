...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-cereal-killer-a1bfe5af/PageContent";

export const metadata: Metadata = {"title":"Cereal Killer | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1687 grid-products" />
      <section id="main" className="context-category-1687 grid-products">
