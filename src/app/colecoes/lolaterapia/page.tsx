...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-lolaterapia-bece2b34/PageContent";

export const metadata: Metadata = {"title":"Lolaterapia | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1807 grid-products" />
      <section id="main" className="context-category-1807 grid-products">
