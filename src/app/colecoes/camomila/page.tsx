...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-camomila-18ffd776/PageContent";

export const metadata: Metadata = {"title":"Camomila | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1470 grid-products" />
      <section id="main" className="context-category-1470 grid-products">
