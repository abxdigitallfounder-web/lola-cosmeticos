...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-be-m-dita-praia-e753c58f/PageContent";

export const metadata: Metadata = {"title":"Be(m)dita Praia | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1468 grid-products" />
      <section id="main" className="context-category-1468 grid-products">
