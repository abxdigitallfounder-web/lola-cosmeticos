...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-plot-twist-eeb1c647/PageContent";

export const metadata: Metadata = {"title":"Plot Twist | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1548 grid-products" />
      <section id="main" className="context-category-1548 grid-products">
