...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-loira-de-farmacia-e91e4bf2/PageContent";

export const metadata: Metadata = {"title":"Loira de Farmácia | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1482 grid-products" />
      <section id="main" className="context-category-1482 grid-products">
