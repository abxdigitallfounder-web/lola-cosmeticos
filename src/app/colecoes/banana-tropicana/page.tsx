...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-banana-tropicana-dc2b32b0/PageContent";

export const metadata: Metadata = {"title":"Banana Tropicana | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1826 grid-products" />
      <section id="main" className="context-category-1826 grid-products">
