...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-dream-cream-a912830e/PageContent";

export const metadata: Metadata = {"title":"Dream Cream | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1477 grid-products" />
      <section id="main" className="context-category-1477 grid-products">
