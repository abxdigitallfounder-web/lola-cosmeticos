...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-comigo-ninguem-pode-bfdbb33c/PageContent";

export const metadata: Metadata = {"title":"Comigo Ninguém Pode | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1472 grid-products" />
      <section id="main" className="context-category-1472 grid-products">
