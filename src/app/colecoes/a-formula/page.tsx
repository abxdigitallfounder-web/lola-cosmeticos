...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-a-formula-ed58c223/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1706 grid-products" />
      <section id="main" className="context-category-1706 grid-products">
