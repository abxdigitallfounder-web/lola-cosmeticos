...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-umectacao-4604aba3/PageContent";

export const metadata: Metadata = {"title":"Umectação | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1686 grid-products" />
      <section id="main" className="context-category-1686 grid-products">
