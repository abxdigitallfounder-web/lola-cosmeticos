...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-morte-subita-e7dc380d/PageContent";

export const metadata: Metadata = {"title":"Morte Súbita | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1488 grid-products" />
      <section id="main" className="context-category-1488 grid-products">
