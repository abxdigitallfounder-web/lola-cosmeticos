...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-papo-reto-62180617/PageContent";

export const metadata: Metadata = {"title":"Papo Reto | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1596 grid-products" />
      <section id="main" className="context-category-1596 grid-products">
