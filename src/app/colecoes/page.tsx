...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-b8394c56/PageContent";

export const metadata: Metadata = {"title":"Coleções | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1456 grid-products" />
      <section id="main" className="context-category-1456 grid-products">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
