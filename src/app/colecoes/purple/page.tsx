...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-purple-7653269c/PageContent";

export const metadata: Metadata = {"title":"Purple | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1660 grid-products" />
      <section id="main" className="context-category-1660 grid-products">
