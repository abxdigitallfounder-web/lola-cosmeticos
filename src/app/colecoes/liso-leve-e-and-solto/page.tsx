...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-liso-leve-e-and-solto-735ed75e/PageContent";

export const metadata: Metadata = {"title":"Liso, leve e and solto | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1481 grid-products" />
      <section id="main" className="context-category-1481 grid-products">
