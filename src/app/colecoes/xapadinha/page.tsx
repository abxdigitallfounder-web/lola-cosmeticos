...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-xapadinha-24b582c6/PageContent";

export const metadata: Metadata = {"title":"Xapadinha | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1547 grid-products" />
      <section id="main" className="context-category-1547 grid-products">
