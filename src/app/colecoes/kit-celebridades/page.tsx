...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-kit-celebridades-c371a0c5/PageContent";

export const metadata: Metadata = {"title":"Kit Celebridades | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1817 grid-products" />
      <section id="main" className="context-category-1817 grid-products">
