...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-babados-da-lola-lola-book-4e0a7663/PageContent";

export const metadata: Metadata = {"title":"Lola Book | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1500 grid-products" />
      <section id="main" className="context-category-1500 grid-products">
