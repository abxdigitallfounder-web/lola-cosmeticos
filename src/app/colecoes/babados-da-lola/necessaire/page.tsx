...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-babados-da-lola-necessaire-79acff60/PageContent";

export const metadata: Metadata = {"title":"Necessaire | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1602 grid-products" />
      <section id="main" className="context-category-1602 grid-products">
