...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-babados-da-lola-sacola-de-rafia-fe6b38d7/PageContent";

export const metadata: Metadata = {"title":"Sacola de Rafia | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1604 grid-products" />
      <section id="main" className="context-category-1604 grid-products">
