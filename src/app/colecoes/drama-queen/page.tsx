...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-drama-queen-feefc38a/PageContent";

export const metadata: Metadata = {"title":"Drama Queen | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1476 grid-products" />
      <section id="main" className="context-category-1476 grid-products">
