...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-bossa-b0f3c53a/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1695 grid-products" />
      <section id="main" className="context-category-1695 grid-products">
