...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-densidade-cab231e4/PageContent";

export const metadata: Metadata = {"title":"Densidade | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1475 grid-products" />
      <section id="main" className="context-category-1475 grid-products">
