...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-danos-vorazes-fb1f336e/PageContent";

export const metadata: Metadata = {"title":"Danos Vorazes | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1474 grid-products" />
      <section id="main" className="context-category-1474 grid-products">
