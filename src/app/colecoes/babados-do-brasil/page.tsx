...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-babados-do-brasil-a51491b9/PageContent";

export const metadata: Metadata = {"title":"Babados do Brasil | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1494 grid-products" />
      <section id="main" className="context-category-1494 grid-products">
