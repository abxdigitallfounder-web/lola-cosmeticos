...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-exterminador-de-frizz-503229ec/PageContent";

export const metadata: Metadata = {"title":"Exterminador de Frizz | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1579 grid-products grid-empty" />
      <section id="main" className="context-category-1579 grid-empty">
