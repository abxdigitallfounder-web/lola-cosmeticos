...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-brancos-e-grisalhos-27e50955/PageContent";

export const metadata: Metadata = {"title":"Brancos e Grisalhos | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1469 grid-products" />
      <section id="main" className="context-category-1469 grid-products">
