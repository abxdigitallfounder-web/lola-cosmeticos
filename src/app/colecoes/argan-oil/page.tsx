...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-argan-oil-699f3134/PageContent";

export const metadata: Metadata = {"title":"Argan Oil | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1465 grid-products" />
      <section id="main" className="context-category-1465 grid-products">
