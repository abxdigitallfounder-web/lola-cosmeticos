...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-milagre-4719adcb/PageContent";

export const metadata: Metadata = {"title":"Milagre! | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1486 grid-products" />
      <section id="main" className="context-category-1486 grid-products">
