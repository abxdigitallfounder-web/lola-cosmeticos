...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-rapunzel-43540d81/PageContent";

export const metadata: Metadata = {"title":"Rapunzel | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1491 grid-products" />
      <section id="main" className="context-category-1491 grid-products">
