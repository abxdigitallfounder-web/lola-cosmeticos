...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-pinga-0c185c60/PageContent";

export const metadata: Metadata = {"title":"Pinga! | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1490 grid-products" />
      <section id="main" className="context-category-1490 grid-products">
