...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/colecoes-volumao-6c8fd626/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1810 grid-products" />
      <section id="main" className="context-category-1810 grid-products">
