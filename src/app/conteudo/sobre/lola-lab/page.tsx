...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/conteudo-sobre-lola-lab-e5a948e2/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 lolalab" />
      <section id="main" className="lolalab">
