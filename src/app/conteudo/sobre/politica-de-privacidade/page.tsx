...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/conteudo-sobre-politica-de-privacidade-8bde9fa3/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 ContentRoute" />
