...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/conteudo-ajuda-regulamento-promocional-9553f65d/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 ContentRoute conteudo-ajuda" />
      <section id="main" className="ContentRoute">
