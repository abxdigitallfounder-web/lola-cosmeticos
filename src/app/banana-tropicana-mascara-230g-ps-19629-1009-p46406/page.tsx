...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/banana-tropicana-mascara-230g-ps-19629-1009-p46406-f033f1f7/PageContent";

export const metadata: Metadata = {"title":"BANANA TROPICANA MASCARA 230G -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46406 ts-theme-light" />
      <section id="main" className="context-product-46406">
