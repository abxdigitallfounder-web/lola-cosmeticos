...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-volumao-linha-completa-p46393-45cb702f/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46393 ts-theme-light" />
      <section id="main" className="context-product-46393">
