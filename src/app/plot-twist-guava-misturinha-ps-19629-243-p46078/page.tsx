...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/plot-twist-guava-misturinha-ps-19629-243-p46078-bc0b3a02/PageContent";

export const metadata: Metadata = {"title":"Plot Twist Guava Misturinha -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46078 ts-theme-light" />
      <section id="main" className="context-product-46078">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
