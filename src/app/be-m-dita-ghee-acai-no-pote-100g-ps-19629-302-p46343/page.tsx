...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/be-m-dita-ghee-acai-no-pote-100g-ps-19629-302-p46343-16315176/PageContent";

export const metadata: Metadata = {"title":"Be(M)dita Ghee Açaí no Pote 100g -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46343 ts-theme-light" />
      <section id="main" className="context-product-46343">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
