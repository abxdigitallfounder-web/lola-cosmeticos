...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/necessaire-doce-vida-ps-19629-293-p46295-104ba1de/PageContent";

export const metadata: Metadata = {"title":"Necessaire Doce Vida -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46295 ts-theme-light" />
      <section id="main" className="context-product-46295">
