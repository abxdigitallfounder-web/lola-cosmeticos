...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/plot-twist-nut-butter-cream-480g-ps-19629-148-p45399-bc47d4d3/PageContent";

export const metadata: Metadata = {"title":"PLOT TWIST NUT BUTTER CREAM 480G -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-45399 ts-theme-light" />
      <section id="main" className="context-product-45399">
