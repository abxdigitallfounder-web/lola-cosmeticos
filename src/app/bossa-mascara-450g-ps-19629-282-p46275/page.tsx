...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/bossa-mascara-450g-ps-19629-282-p46275-d3cc3d87/PageContent";

export const metadata: Metadata = {"title":"BOSSA MASCARA 450G -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46275 ts-theme-light" />
      <section id="main" className="context-product-46275">
