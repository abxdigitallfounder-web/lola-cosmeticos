...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-cuidados-especificos-551f29fb/PageContent";

export const metadata: Metadata = {"title":"Cuidados específicos | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1771 grid-products" />
      <section id="main" className="context-category-1771 grid-products">
