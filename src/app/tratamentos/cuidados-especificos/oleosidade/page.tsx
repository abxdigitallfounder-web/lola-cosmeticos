...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-cuidados-especificos-oleosidade-7e79392a/PageContent";

export const metadata: Metadata = {"title":"Oleosidade | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1773 grid-products" />
      <section id="main" className="context-category-1773 grid-products">
