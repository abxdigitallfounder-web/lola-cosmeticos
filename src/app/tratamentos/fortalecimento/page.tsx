...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-fortalecimento-8b46e069/PageContent";

export const metadata: Metadata = {"title":"Fortalecimento | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1766 grid-products" />
      <section id="main" className="context-category-1766 grid-products">
