...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-cronograma-capilar-e590e43e/PageContent";

export const metadata: Metadata = {"title":"Cronograma Capilar | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1529 grid-products" />
      <section id="main" className="context-category-1529 grid-products">
