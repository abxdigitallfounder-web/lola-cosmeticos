...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-cronograma-capilar-nutricao-052372af/PageContent";

export const metadata: Metadata = {"title":"Nutrição | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1532 grid-products" />
      <section id="main" className="context-category-1532 grid-products">
