...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-cronograma-capilar-hidratacao-405d5e24/PageContent";

export const metadata: Metadata = {"title":"Hidratação | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1531 grid-products" />
      <section id="main" className="context-category-1531 grid-products">
