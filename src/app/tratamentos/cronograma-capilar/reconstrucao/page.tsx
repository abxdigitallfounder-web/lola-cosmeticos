...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-cronograma-capilar-reconstrucao-3ad35ae5/PageContent";

export const metadata: Metadata = {"title":"Reconstrução | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1533 grid-products" />
      <section id="main" className="context-category-1533 grid-products">
