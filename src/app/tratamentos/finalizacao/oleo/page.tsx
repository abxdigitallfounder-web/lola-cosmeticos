...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-finalizacao-oleo-688522b5/PageContent";

export const metadata: Metadata = {"title":"Óleo | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1770 grid-products" />
      <section id="main" className="context-category-1770 grid-products">
