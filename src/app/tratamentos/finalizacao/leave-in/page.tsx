...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-finalizacao-leave-in-749f2eb8/PageContent";

export const metadata: Metadata = {"title":"Leave In | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1769 grid-products" />
      <section id="main" className="context-category-1769 grid-products">
