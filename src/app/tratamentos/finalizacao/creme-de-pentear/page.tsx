...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-finalizacao-creme-de-pentear-2475a395/PageContent";

export const metadata: Metadata = {"title":"Creme de Pentear | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1768 grid-products" />
      <section id="main" className="context-category-1768 grid-products">
