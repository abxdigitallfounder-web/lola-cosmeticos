...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-finalizacao-28972c03/PageContent";

export const metadata: Metadata = {"title":"Finalização | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1767 grid-products" />
      <section id="main" className="context-category-1767 grid-products">
