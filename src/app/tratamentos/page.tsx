...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-8a17264f/PageContent";

export const metadata: Metadata = {"title":"TRATAMENTOS | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1764 grid-products" />
      <section id="main" className="context-category-1764 grid-products">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
