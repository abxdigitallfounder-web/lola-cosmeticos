...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-uso-diario-55480637/PageContent";

export const metadata: Metadata = {"title":"Uso diário | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1650 grid-products" />
      <section id="main" className="context-category-1650 grid-products">
