...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-brilho-1b5f1082/PageContent";

export const metadata: Metadata = {"title":"Brilho | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1765 grid-products" />
      <section id="main" className="context-category-1765 grid-products">
