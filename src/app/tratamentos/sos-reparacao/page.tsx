...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tratamentos-sos-reparacao-bddeccb5/PageContent";

export const metadata: Metadata = {"title":"SOS Reparação | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1530 grid-products" />
      <section id="main" className="context-category-1530 grid-products">
