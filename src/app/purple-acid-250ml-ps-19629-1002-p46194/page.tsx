...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/purple-acid-250ml-ps-19629-1002-p46194-e91b6cc1/PageContent";

export const metadata: Metadata = {"title":"Purple Acid 250ml -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46194 ts-theme-light" />
      <section id="main" className="context-product-46194">
