...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/plot-twist-nut-gel-230g-ps-19629-256-p46172-f96d7407/PageContent";

export const metadata: Metadata = {"title":"Plot Twist Nut Gel 230g -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46172 ts-theme-light" />
      <section id="main" className="context-product-46172">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
