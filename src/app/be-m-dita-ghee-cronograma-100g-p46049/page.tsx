...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/be-m-dita-ghee-cronograma-100g-p46049-2eb145fb/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46049 ts-theme-light" />
      <section id="main" className="context-product-46049">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
