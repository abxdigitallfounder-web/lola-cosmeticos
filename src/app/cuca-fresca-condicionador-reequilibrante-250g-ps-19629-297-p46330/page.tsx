...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/cuca-fresca-condicionador-reequilibrante-250g-ps-19629-297-p46330-e3cb8e7a/PageContent";

export const metadata: Metadata = {"title":"Cuca Fresca Condicionador Reequilibrante 250g -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46330 ts-theme-light" />
      <section id="main" className="context-product-46330">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
