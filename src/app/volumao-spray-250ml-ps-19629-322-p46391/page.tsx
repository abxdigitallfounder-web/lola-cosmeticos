...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/volumao-spray-250ml-ps-19629-322-p46391-94a21422/PageContent";

export const metadata: Metadata = {"title":"Volumão Spray 250ml -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46391 ts-theme-light" />
      <section id="main" className="context-product-46391">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
