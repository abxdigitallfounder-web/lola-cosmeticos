...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-cuca-fresca-anticaspa-p46335-41963d52/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46335 ts-theme-light" />
      <section id="main" className="context-product-46335">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
