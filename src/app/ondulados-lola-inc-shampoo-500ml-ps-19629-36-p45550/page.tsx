...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/ondulados-lola-inc-shampoo-500ml-ps-19629-36-p45550-6f779e1e/PageContent";

export const metadata: Metadata = {"title":"ONDULADOS LOLA INC SHAMPOO 500ML -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-45550 ts-theme-light" />
      <section id="main" className="context-product-45550">
