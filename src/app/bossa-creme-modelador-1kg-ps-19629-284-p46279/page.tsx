...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/bossa-creme-modelador-1kg-ps-19629-284-p46279-07c892d5/PageContent";

export const metadata: Metadata = {"title":"BOSSA CREME MODELADOR 1KG -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46279 ts-theme-light" />
      <section id="main" className="context-product-46279">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
