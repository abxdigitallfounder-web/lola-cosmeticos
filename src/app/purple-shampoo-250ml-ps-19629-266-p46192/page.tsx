...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/purple-shampoo-250ml-ps-19629-266-p46192-e091a131/PageContent";

export const metadata: Metadata = {"title":"Purple Shampoo 250ml -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46192 ts-theme-light" />
      <section id="main" className="context-product-46192">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
