...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/ondulados-lola-inc-condicionador-500g-ps-19629-31-p45398-5ad80e46/PageContent";

export const metadata: Metadata = {"title":"ONDULADOS LOLA INC CONDICIONADOR 500g -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-45398 ts-theme-light" />
      <section id="main" className="context-product-45398">
