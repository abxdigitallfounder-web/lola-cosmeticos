...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/bahia-a-vista-mousse-200ml-ps-19629-90-p45529-1cc327de/PageContent";

export const metadata: Metadata = {"title":"BAHIA A VISTA MOUSSE 200ML -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-45529 ts-theme-light" />
      <section id="main" className="context-product-45529">
