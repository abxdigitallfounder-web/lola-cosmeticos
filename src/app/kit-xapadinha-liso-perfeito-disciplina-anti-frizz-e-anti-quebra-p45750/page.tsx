...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-xapadinha-liso-perfeito-disciplina-anti-frizz-e-anti-quebra-p45750-590cddf6/PageContent";

export const metadata: Metadata = {"title":"Kit Xapadinha Liso Perfeito -  Disciplina, Anti-Frizz e Anti-Quebra -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-45750 ts-theme-light" />
      <section id="main" className="context-product-45750">
