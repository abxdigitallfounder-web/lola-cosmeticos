...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-feira-cronolola-ps-19629-250-p46131-ca1686e4/PageContent";

export const metadata: Metadata = {"title":"Kit Feira Cronolola -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46131 ts-theme-light" />
      <section id="main" className="context-product-46131">
