...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-rapunzel-colecao-completa-p46395-73b5c8ee/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46395 ts-theme-light" />
      <section id="main" className="context-product-46395">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
