...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-completo-banana-tropicana-p46408-8dd69bc3/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46408 ts-theme-light" />
      <section id="main" className="context-product-46408">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
