...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/papo-reto-mascara-270ml-ps-19629-211-p45949-73c1e4ac/PageContent";

export const metadata: Metadata = {"title":"Papo Reto Máscara 270ml -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-45949 ts-theme-light" />
      <section id="main" className="context-product-45949">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
