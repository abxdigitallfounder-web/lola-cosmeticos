...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/bossa-mousse-150ml-ps-19629-323-p46396-490d676e/PageContent";

export const metadata: Metadata = {"title":"BOSSA MOUSSE 150ML -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46396 ts-theme-light" />
      <section id="main" className="context-product-46396">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
