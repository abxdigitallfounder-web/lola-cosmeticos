...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tannic-mascara-450g-ps-19629-290-p46289-bc31c554/PageContent";

export const metadata: Metadata = {"title":"TANNIC MÁSCARA 450G -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46289 ts-theme-light" />
      <section id="main" className="context-product-46289">
