...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-morte-subita-trio-ps-19629-308-p46358-57b004e2/PageContent";

export const metadata: Metadata = {"title":"KIT MORTE SÚBITA TRIO -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46358 ts-theme-light" />
      <section id="main" className="context-product-46358">
