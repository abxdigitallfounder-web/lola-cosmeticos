...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-cuca-fresca-controle-de-oleosidade-p46336-f21bd0d9/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46336 ts-theme-light" />
      <section id="main" className="context-product-46336">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
