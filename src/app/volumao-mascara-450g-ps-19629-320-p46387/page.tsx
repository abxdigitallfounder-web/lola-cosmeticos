...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/volumao-mascara-450g-ps-19629-320-p46387-18997a9d/PageContent";

export const metadata: Metadata = {"title":"Volumão Máscara 450g -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46387 ts-theme-light" />
      <section id="main" className="context-product-46387">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
