...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-pinga-p46133-28ab1990/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46133 ts-theme-light" />
      <section id="main" className="context-product-46133">
