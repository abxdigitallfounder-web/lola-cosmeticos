...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/promocao-8e631b9a/PageContent";

export const metadata: Metadata = {"title":"PROMOÇÃO | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1610 grid-products" />
      <section id="main" className="context-category-1610 grid-products">
