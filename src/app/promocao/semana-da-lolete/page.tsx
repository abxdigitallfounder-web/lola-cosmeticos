...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/promocao-semana-da-lolete-ed806967/PageContent";

export const metadata: Metadata = {"title":"Semana da Lolete | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1828 grid-products" />
      <section id="main" className="context-category-1828 grid-products">
