...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/promocao-achadinhos-8b7a0d30/PageContent";

export const metadata: Metadata = {"title":"Achadinhos | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1741 grid-products" />
      <section id="main" className="context-category-1741 grid-products">
