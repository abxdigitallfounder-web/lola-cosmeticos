...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
 return <html suppressHydrationWarning lang="pt-BR" className={lato.variable}><head><script dangerouslySetInnerHTML={{ __html: `document.documentElement.dataset.lolaDevice = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || (navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1) ? "phone" : "desktop";` }} /><link rel="stylesheet" href="/sites/www-lolacosmetics-com-br-b005530a/root-8a5edab2/source.css" /></head><body suppressHydrationWarning className="column-1 HomeRoute lola-clone">{children}<Tracking /></body></html>;
}
