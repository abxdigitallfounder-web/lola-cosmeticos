...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-a-formula-lamelar-p46345-dcfe78d8/PageContent";

export const metadata: Metadata = {"title":""};

// Captured product-kit page. Everything between the header and the footer is the
// source's own #middle subtree, replayed whole so the theme's selectors keep matching.
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46345 ts-theme-light" />
      <section id="main" className="context-product-46345">
