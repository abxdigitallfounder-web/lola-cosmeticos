...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/bossa-creme-modelador-500g-ps-19629-283-p46277-ef1bd023/PageContent";

export const metadata: Metadata = {"title":"BOSSA CREME MODELADOR 500G -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46277 ts-theme-light" />
      <section id="main" className="context-product-46277">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
