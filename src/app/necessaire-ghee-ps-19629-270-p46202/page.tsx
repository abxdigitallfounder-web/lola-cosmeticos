...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/necessaire-ghee-ps-19629-270-p46202-b205c5e4/PageContent";

export const metadata: Metadata = {"title":"Necessaire Ghee -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46202 ts-theme-light" />
      <section id="main" className="context-product-46202">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
