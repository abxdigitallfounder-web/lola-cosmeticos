...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/bossa-gelatina-modeladora-500g-ps-19629-285-p46281-841c434e/PageContent";

export const metadata: Metadata = {"title":"BOSSA GELATINA MODELADORA 500G -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46281 ts-theme-light" />
      <section id="main" className="context-product-46281">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
