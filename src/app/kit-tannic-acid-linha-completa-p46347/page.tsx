...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/kit-tannic-acid-linha-completa-p46347-600411e9/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46347 ts-theme-light" />
      <section id="main" className="context-product-46347">
