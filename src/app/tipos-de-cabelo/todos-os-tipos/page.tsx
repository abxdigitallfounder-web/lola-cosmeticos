...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tipos-de-cabelo-todos-os-tipos-2e9d24a6/PageContent";

export const metadata: Metadata = {"title":"Todos os tipos de cabelos | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1774 grid-products" />
      <section id="main" className="context-category-1774 grid-products">
