...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tipos-de-cabelo-cacheado-f3e994aa/PageContent";

export const metadata: Metadata = {"title":"Cachos & Curvas | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1515 grid-products" />
      <section id="main" className="context-category-1515 grid-products">
