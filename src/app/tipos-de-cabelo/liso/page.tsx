...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tipos-de-cabelo-liso-253abfbe/PageContent";

export const metadata: Metadata = {"title":"Lisos | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1512 grid-products" />
      <section id="main" className="context-category-1512 grid-products">
