...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/tipos-de-cabelo-c8d37892/PageContent";

export const metadata: Metadata = {"title":"TIPOS DE CABELO - TIPOS DE CABELO | Lola Cosmetics Escolha Lola, escolha ser feliz!"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-category-1461 grid-products" />
      <section id="main" className="context-category-1461 grid-products">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
