...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/banana-tropicana-shampoo-esfoliante-100g-ps-19629-1005-p46398-d2f14af2/PageContent";

export const metadata: Metadata = {"title":"BANANA TROPICANA SHAMPOO ESFOLIANTE 100G -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46398 ts-theme-light" />
      <section id="main" className="context-product-46398">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
