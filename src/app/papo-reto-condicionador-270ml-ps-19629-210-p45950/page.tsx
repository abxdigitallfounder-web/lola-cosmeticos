...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/papo-reto-condicionador-270ml-ps-19629-210-p45950-322d2442/PageContent";

export const metadata: Metadata = {"title":"Papo Reto Condicionador 270ml -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-45950 ts-theme-light" />
      <section id="main" className="context-product-45950">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
