...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/banana-tropicana-condicionador-250g-ps-19629-1007-p46402-9b736e8f/PageContent";

export const metadata: Metadata = {"title":"BANANA TROPICANA CONDICIONADOR 250G -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46402 ts-theme-light" />
      <section id="main" className="context-product-46402">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
