...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/purple-mask-100g-ps-19629-286-p46283-1ccba691/PageContent";

export const metadata: Metadata = {"title":"PURPLE MASK 100G -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46283 ts-theme-light" />
      <section id="main" className="context-product-46283">
