...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/bossa-shampoo-500ml-ps-19629-281-p46273-eecb8732/PageContent";

export const metadata: Metadata = {"title":"BOSSA SHAMPOO 500ML -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-46273 ts-theme-light" />
      <section id="main" className="context-product-46273">
