...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/meu-cacho-minha-vida-creme-pentear-500g-ps-19629-73-p45409-3930531f/PageContent";

export const metadata: Metadata = {"title":"MEU CACHO MINHA VIDA CREME PENTEAR 500g -"};
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-45409 ts-theme-light" />
      <section id="main" className="context-product-45409">
        <Header />
        <div id="bg-search" />
        <PageContent />
        <Footer />
