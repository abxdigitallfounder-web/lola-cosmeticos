...
import PageContent from "@/components/sites/www-lolacosmetics-com-br-b005530a/trio-be-m-dita-ghee-reconstrucao-100g-p45971-34c606f9/PageContent";
...
export default function Page() {
  return (
    <>
      <BodyClass value="column-1 context-product-45971 ts-theme-light" />
      <section id="main" className="context-product-45971">
