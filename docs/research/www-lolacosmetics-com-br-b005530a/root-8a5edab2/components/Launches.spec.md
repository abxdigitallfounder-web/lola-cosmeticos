...
## Overview
- Target: src/components/sites/www-lolacosmetics-com-br-b005530a/root-8a5edab2/Launches.tsx
...
## DOM Structure
Exact sanitized source markup is provided as fragments.Launches in fragments.json. All source class names and inline SVGs retained. Render as HTML with display:contents wrapper to preserve selectors. Original CSS is loaded globally from local source.css, including all descendant values. Do not approximate or override original styles.
...
Vem ver nossos últimos lançamentos ✨ Ver mais [] (2) Volumão Máscara 450g 10% de cashback R$ 64,90 2 x R$ 32,45 sem juros - + Comprar ADICIONAR À SACOLA [] (5) Volumão Shampoo 250ml 10% de cashback R$ 39,90 1 x R$ 39,90 sem juros - + Comprar ADICIONAR À SACOLA [] (2) Volumão Spray 250ml 10% de cashback R$ 59,90 1 x R$ 59,90 sem juros - + Comprar ADICIONAR À SACOLA [] (12) MORTE SÚBITA ÓLEO 50ML 10% de cashback R$ 44,90 1 x R$ 44,90 sem juros - + Comprar ADICIONAR À SACOLA Ver mais
