# SocialLinks Specification

## Overview
- Target: src/components/sites/www-lolacosmetics-com-br-b005530a/root-8a5edab2/SocialLinks.tsx
...
## DOM Structure
Exact sanitized source markup is provided as fragments.SocialLinks in fragments.json. All source class names and inline SVGs retained. Render as HTML with display:contents wrapper to preserve selectors. Original CSS is loaded globally from local source.css, including all descendant values. Do not approximate or override original styles.
...
Siga a Lola nas redes sociais Fique por dentro de tudo que rola no mundo da Lola!
